...
#+begin_src emacs-lisp
    ...
    ;; This is quite ugly, only register the lsp-client if we have started emacs from the kontrakcja/ folder.
    (if (string= (expand-file-name default-directory) (expand-file-name "~/scrive/repo/kontrakcja/"))
        (lsp-register-client-wrapper '("docker" "compose" "-f" "/home/iori/scrive/repo/kontrakcja/docker/docker-compose.iori.yml" "exec" "devel-extended" "static-ls")))
